...
<body class="FontPrecidnet">
    ...
    <ul class="nav">
        ...
        <li class="navlist"><a class="navlink" href="FundFinder.php">Fund Finder</a></li>
	...
	<button type="button" onclick="display()" style="margin-left:500px;">Load Preferences</button>
        <h1>Your Results:</h1>
        <br />
        <p style="padding-left:20px; padding-right:20px;" id="finalstr">SUGGESTED SCHEME: ERROR</p>
        <br />
        <p style="padding-left:20px; padding-right:20px;" id="final">ESTIMATED VALUE: ERROR</p>
    </div>
